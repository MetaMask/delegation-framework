...
contract SignDelegationWithSafe is Script {
    ...
    function _createSwapSubVaultDelegation(bytes32 _parentDelegationHash)
        internal
        view
     ...
     */
    function exampleSwapByDelegation(Delegation memory _vaultDelegation, Delegation memory _subVaultDelegation)
        public
        pure
    {
