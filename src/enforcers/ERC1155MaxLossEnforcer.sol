...
/**
 * @title ERC1155MaxLossEnforcer
 * @dev This contract enforces that the ERC1155 token balance of a recipient for a specific token ID
 * has decreased by at most the specified amount after the execution, measured between the `beforeHook` and `afterHook` calls.
 */
contract ERC1155MaxLossEnforcer is CaveatEnforcer {
    ////////////////////////////// State //////////////////////////////
     ...
     * - next 32 bytes: amount the balance should decrease by, at most.
     * @param _delegationHash The hash of the delegation.
     */
    function beforeHook(
        ...
        override
    {
        ...
        require(!isLocked[hashKey_], "ERC1155MaxLossEnforcer:enforcer-is-locked");
    ...
    /**
     * @notice This function enforces that the recipient's ERC1155 token balance has decreased by at most the amount provided.
     * @param _terms 104 bytes where:
     * - first 20 bytes: address of the ERC1155 token,
     * - next 20 bytes: address of the recipient,
     * - next 32 bytes: token ID,
        ...
        override
    {
        ...
        uint256 balance_ = IERC1155(token_).balanceOf(recipient_, tokenId_);
        require(balance_ >= balanceCache[hashKey_] - amount_, "ERC1155MaxLossEnforcer:balance-not-gt");
    }
     ...
     * @return amount_ The amount the balance should decrease by, at most.
     */
    ...
    {
        require(_terms.length == 104, "ERC1155MaxLossEnforcer:invalid-terms-length");
