...
contract MetaSwapAdapterTest is CaveatEnforcerBaseTest {
    ...
    function test_enforcerRejectsInvalidBatchLength() public {
        ...
        vm.expectRevert("MetaSwapTransferSwapEnforcer:invalid-batch-length");
        enforcer.beforeHook(
    ...
    function test_enforcerRejectsInvalidTerms() public {
        ...
        vm.expectRevert("MetaSwapTransferSwapEnforcer:invalid-zero-address");
        ...
        vm.expectRevert("MetaSwapTransferSwapEnforcer:invalid-zero-amount");
        ...
        vm.expectRevert("MetaSwapTransferSwapEnforcer:identical-tokens");
    ...
    function test_enforcerRejectsWrongCallTypeForNativeAndErc20() public {
        ...
        vm.expectRevert("MetaSwapTransferSwapEnforcer:invalid-call-type");
    ...
    function test_enforcerRejectsWrongNativeExecutionValue() public {
        ...
        vm.expectRevert("MetaSwapTransferSwapEnforcer:invalid-swap-call");
    ...
    function test_enforcerRejectsInvalidTransfer() public {
        ...
        vm.prank(address(delegationManager));
        vm.expectRevert("MetaSwapTransferSwapEnforcer:invalid-transfer-call");
        enforcer.beforeHook(
    ...
    function test_integrationRejectsReplay() public {
        ...
        vm.expectRevert("MetaSwapTransferSwapEnforcer:delegation-already-used");
        _redeem(delegation_, execution_, automation);
    }
